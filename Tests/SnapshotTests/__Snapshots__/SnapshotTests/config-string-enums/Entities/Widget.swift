...
public struct Widget: Codable {
    ...
    public init(count: Int32? = nil, created: Date? = nil, id: Int64, isActive: Bool? = nil, link: URL? = nil, metadata: [String: AnyJSON]? = nil, ratio: Float? = nil, status: String, zeta: String) {
        self.count = count
